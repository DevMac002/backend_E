...
<head>
  ...
  <style nonce="${nonce}">
    ...
    *{box-sizing:border-box}body{font:14px system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;margin:0;min-height:100vh;color:var(--ink);background:#e8ebf5}
    ...
    @media(max-width:620px){main{padding:14px;overflow-x:hidden}.filters,.stats,.lists{grid-template-columns:1fr}.toolbar{align-items:flex-start;flex-direction:column}.brand h1{font-size:23px}.tableWrap{max-width:100vw}}
  </style>
</head>
<body>
  <main>
