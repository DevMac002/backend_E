...
router.post('/', authMiddleware, requireNotBanned, postLimiter, upload.single('file'), controller.createPost);
...
router.post('/:id/comments', authMiddleware, requireNotBanned, controller.addComment);
