    ...
    schemas: {
      ...
      PostCreate: {
        ...
        properties: {
          ...
          type: {
            type: 'string',
            enum: ['post', 'photo', 'predication', 'annonce', 'sondage', 'quiz'],
            description: 'Type de publication',
          },
          visible_to: {
            type: 'string',
            enum: ['all', 'followers', 'only_me'],
            description: 'Audience de la publication',
          },
          options: { type: ['array', 'object', 'string'], description: 'Options de sondage ou de quiz (JSON ou array)' },
          reponse_correcte: { type: 'string', description: 'Réponse correcte du quiz (id ou value)' },
          date_limite: { type: 'string', format: 'date-time', description: 'Date limite pour sondage/quiz' },
          location: { type: 'string', description: 'Emplacement associé à la publication' },
          hide_like_count: { type: 'boolean', description: 'Masquer le compteur de likes' },
          disable_comments: { type: 'boolean', description: 'Désactiver les commentaires' },
          scheduled_at: { type: 'string', format: 'date-time', description: 'Date de publication programmée' },
          tagged_usernames: { type: 'string', description: 'Liste JSON de usernames tagués' },
          file: { type: 'string', format: 'binary', description: 'Fichier média uploadé (champ name: file)' },
        },
      },
      CommentCreate: {
        type: 'object',
      ...
      StoryCreate: {
        ...
        properties: {
          ...
          duration: { type: 'integer', description: 'Durée en secondes (optionnel) pour le viewer' },
          media: { type: 'string', description: 'URL du média ou chemin de fichier; upload via multipart field `media`' },
        },
      },
      StoryView: {
        type: 'object',
            ...
            'multipart/form-data': {
              schema: {
                ...
                properties: {
                  ...
                  options: { type: 'string', description: 'Options de quiz/sondage en JSON ou configuration' },
                  reponse_correcte: { type: 'string', description: 'Réponse correcte du quiz (id)' },
                  date_limite: { type: 'string', format: 'date-time', description: 'Date limite pour sondage/quiz' },
                  location: { type: 'string', description: 'Emplacement associé à la publication' },
                  hide_like_count: { type: 'boolean', description: 'Masquer le compteur de likes' },
                  disable_comments: { type: 'boolean', description: 'Désactiver les commentaires' },
                  scheduled_at: { type: 'string', format: 'date-time', description: 'Date de publication programmée' },
                  tagged_usernames: { type: 'string', description: 'Liste JSON de usernames tagués' },
                  file: { type: 'string', format: 'binary', description: 'Fichier média (champ name: file)' },
                },
              },
            },
          },
